...
export const FaqSection = () => {
    ...
    return (
        <div className="relative max-w-2xl mx-auto flex flex-col items-center justify-center px-4 md:px-0">
            ...
            <SectionTitle text1="FAQ's" text2="Frequently asked questions" text3="Everything you need to know about using the platform. If you have any questions, feel free to contact us." />
            <div className="mt-8">
